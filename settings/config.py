...
#Bot's TOKEN (токен бота)
TOKEN = '8037273698:AAFfkurGmHsUTrBAK7XHN-XqFBvE6aOoWlY' #<- впишите токен бота


#Admin's ID (идентификатор админа)
ADMIN = 'admin' #<- впишите айди админа
